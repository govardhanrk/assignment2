...
public class Node {
	...
	// default constructor
	public Node() {
		this(new VehicleRecord()); // storing null Record objects
	}

	public Node(VehicleRecord data) {
		this(data, null, null);
	}

	public Node(VehicleRecord data, Node leftChild, Node rightChild) {
		_data = data;
		setLeftChild(leftChild);
		setRightChild(rightChild);
	}

	public VehicleRecord getData() {
		return _data;
	}

	public void setData(VehicleRecord data) {
		_data = data;
	}
